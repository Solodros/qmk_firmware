...
// Zhaqian custom keycodes
    ...
    RGB_IND_NUM_LOCK_LF = 0x7FC4,
    RGB_IND_NUM_LOCK_LR = 0x7FC5,
    RGB_IND_NUM_LOCK_HI = 0x7FC6,
    RGB_IND_NUM_LOCK_HD = 0x7FC7,
    RGB_IND_NUM_LOCK_SI = 0x7FC8,
    RGB_IND_NUM_LOCK_SD = 0x7FC9,
    RGB_IND_NUM_LOCK_VI = 0x7FCA,
    RGB_IND_NUM_LOCK_VD = 0x7FCB,

    RGB_IND_CAPS_LOCK_LF = 0x7FCC,
    RGB_IND_CAPS_LOCK_LR = 0x7FCD,
    RGB_IND_CAPS_LOCK_HI = 0x7FCE,
    RGB_IND_CAPS_LOCK_HD = 0x7FCF,
    RGB_IND_CAPS_LOCK_SI = 0x7FD0,
    RGB_IND_CAPS_LOCK_SD = 0x7FD1,
    RGB_IND_CAPS_LOCK_VI = 0x7FD2,
    RGB_IND_CAPS_LOCK_VD = 0x7FD3,

    RGB_IND_SCROLL_LOCK_LF = 0x7FD4,
    RGB_IND_SCROLL_LOCK_LR = 0x7FD5,
    RGB_IND_SCROLL_LOCK_HI = 0x7FD6,
    RGB_IND_SCROLL_LOCK_HD = 0x7FD7,
    RGB_IND_SCROLL_LOCK_SI = 0x7FD8,
    RGB_IND_SCROLL_LOCK_SD = 0x7FD9,
    RGB_IND_SCROLL_LOCK_VI = 0x7FDA,
    RGB_IND_SCROLL_LOCK_VD = 0x7FDB,
...
// Zhaqian custom keycodes alias
    ...
    DIAL_RC    = RADIAL_RIGHT_CONTINUE,   
    RGB_INDTOG = RGB_IND_TOGGLE,
    RGB_INDMF  = RGB_IND_MODE_FORWARD,
    RGB_INDMR  = RGB_IND_MODE_REVERSE,

    RGB_NUM_TOG           = RGB_IND_NUM_LOCK_TOG,
    RGB_NUM_MF            = RGB_IND_NUM_LOCK_MF,
    RGB_NUM_MR            = RGB_IND_NUM_LOCK_MR,
    RGB_CAPS_TOG          = RGB_IND_CAPS_LOCK_TOG,
    RGB_CAPS_MF           = RGB_IND_CAPS_LOCK_MF,
    RGB_CAPS_MR           = RGB_IND_CAPS_LOCK_MR,
    RGB_SCROLL_TOG        = RGB_IND_SCROLL_LOCK_TOG,
    RGB_SCROLL_MF         = RGB_IND_SCROLL_LOCK_MF,
    RGB_SCROLL_MR         = RGB_IND_SCROLL_LOCK_MR,

    WIN_FN    = WINDOWS_FN_KEY,
    MAC_FN    = MACOS_FN_KEY,

    RGB_NUM_LF     = RGB_IND_NUM_LOCK_LF,
    RGB_NUM_LR     = RGB_IND_NUM_LOCK_LR,
    RGB_NUM_HI     = RGB_IND_NUM_LOCK_HI,
    RGB_NUM_HD     = RGB_IND_NUM_LOCK_HD,
    RGB_NUM_SI     = RGB_IND_NUM_LOCK_SI,
    RGB_NUM_SD     = RGB_IND_NUM_LOCK_SD,
    RGB_NUM_VI     = RGB_IND_NUM_LOCK_VI,
    RGB_NUM_VD     = RGB_IND_NUM_LOCK_VD,

    RGB_CAPS_LF    = RGB_IND_CAPS_LOCK_LF,
    RGB_CAPS_LR    = RGB_IND_CAPS_LOCK_LR,
    RGB_CAPS_HI    = RGB_IND_CAPS_LOCK_HI,
    RGB_CAPS_HD    = RGB_IND_CAPS_LOCK_HD,
    RGB_CAPS_SI    = RGB_IND_CAPS_LOCK_SI,
    RGB_CAPS_SD    = RGB_IND_CAPS_LOCK_SD,
    RGB_CAPS_VI    = RGB_IND_CAPS_LOCK_VI,
    RGB_CAPS_VD    = RGB_IND_CAPS_LOCK_VD,

    RGB_SCROLL_LF  = RGB_IND_SCROLL_LOCK_LF,
    RGB_SCROLL_LR  = RGB_IND_SCROLL_LOCK_LR,
    RGB_SCROLL_HI  = RGB_IND_SCROLL_LOCK_HI,
    RGB_SCROLL_HD  = RGB_IND_SCROLL_LOCK_HD,
    RGB_SCROLL_SI  = RGB_IND_SCROLL_LOCK_SI,
    RGB_SCROLL_SD  = RGB_IND_SCROLL_LOCK_SD,
    RGB_SCROLL_VI  = RGB_IND_SCROLL_LOCK_VI,
    RGB_SCROLL_VD  = RGB_IND_SCROLL_LOCK_VD,
};
