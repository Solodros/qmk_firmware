...
*/
    RGB_IND_NUM_LOCK_TOG    = 0x7FB9,
    RGB_IND_CAPS_LOCK_TOG   = 0x7FBA,
    RGB_IND_SCROLL_LOCK_TOG = 0x7FBB,
    RGB_IND_LAYER_1_TOG     = 0x7FBC,
    RGB_IND_LAYER_2_TOG     = 0x7FBD,
    RGB_IND_LAYER_3_TOG     = 0x7FBE,
    RGB_IND_LAYER_4_TOG     = 0x7FBF,
    RGB_INDS_MODE_F         = 0x7FC0,
    RGB_INDS_MODE_R         = 0x7FC1,
    RGB_INDS_LED_F          = 0x7FC2,
    RGB_INDS_LED_R          = 0x7FC3,
    RGB_INDS_HUE_I          = 0x7FC4,
    RGB_INDS_HUE_D          = 0x7FC5,
    RGB_INDS_SAT_I          = 0x7FC6,
    RGB_INDS_SAT_D          = 0x7FC7,
    RGB_INDS_VAL_I          = 0x7FC8,
    RGB_INDS_VAL_D          = 0x7FC9,

    WINDOWS_FN_KEY          = 0x7FCA,
    MACOS_FN_KEY            = 0x7FCB,
...
/*
    ...
    MAC_FN    = MACOS_FN_KEY,
*/
    NUM_RGB_TOG          = RGB_IND_NUM_LOCK_TOG,
    CAPS_RGB_TOG         = RGB_IND_CAPS_LOCK_TOG,
    SCROLL_RGB_TOG       = RGB_IND_SCROLL_LOCK_TOG,
    LAYER1_RGB_TOG       = RGB_IND_LAYER_1_TOG,
    LAYER2_RGB_TOG       = RGB_IND_LAYER_2_TOG,
    LAYER3_RGB_TOG       = RGB_IND_LAYER_3_TOG,
    LAYER4_RGB_TOG       = RGB_IND_LAYER_4_TOG,

    INDS_RGB_MF      = RGB_INDS_MODE_F,
    INDS_RGB_MR      = RGB_INDS_MODE_R,
    INDS_RGB_LF      = RGB_INDS_LED_F,
    INDS_RGB_LR      = RGB_INDS_LED_R,
    INDS_RGB_HI      = RGB_INDS_HUE_I,
    INDS_RGB_HD      = RGB_INDS_HUE_D,
    INDS_RGB_SI      = RGB_INDS_SAT_I,
    INDS_RGB_SD      = RGB_INDS_SAT_D,
    INDS_RGB_VI      = RGB_INDS_VAL_I,
    INDS_RGB_VD      = RGB_INDS_VAL_D,
