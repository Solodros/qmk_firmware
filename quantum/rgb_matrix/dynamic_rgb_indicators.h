...
#if !defined (DYNAMIC_RGB_INDICATORS_MAXIMUM_BRIGHTNESS)  || (DYNAMIC_RGB_INDICATORS_MAXIMUM_BRIGHTNESS > UINT8_MAX) 
    #undef DYNAMIC_RGB_INDICATORS_MAXIMUM_BRIGHTNESS
    #define DYNAMIC_RGB_INDICATORS_MAXIMUM_BRIGHTNESS RGB_MATRIX_MAXIMUM_BRIGHTNESS
#endif

#if !defined (DYNAMIC_RGB_INDICATORS_DEFAULT_VAL) ||  (DYNAMIC_RGB_INDICATORS_DEFAULT_VAL > DYNAMIC_RGB_INDICATORS_MAXIMUM_BRIGHTNESS) || (DYNAMIC_RGB_INDICATORS_DEFAULT_VAL > UINT8_MAX)
    #undef DYNAMIC_RGB_INDICATORS_DEFAULT_VAL
    #define DYNAMIC_RGB_INDICATORS_DEFAULT_VAL DYNAMIC_RGB_INDICATORS_MAXIMUM_BRIGHTNESS
#endif
