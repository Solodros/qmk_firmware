...
//#if !defined(DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS) || DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS > UINT8_MAX
//#undef DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS
//#define DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS RGB_MATRIX_MAXIMUM_BRIGHTNESS
//#endif

//#if !defined(DYNAMIC_RGB_MATRIX_STARTUP_VAL) ||  DYNAMIC_RGB_MATRIX_STARTUP_VAL > DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS
//#undef DYNAMIC_RGB_MATRIX_STARTUP_VAL
//#define DYNAMIC_RGB_MATRIX_STARTUP_VAL DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS
//#endif

#if defined DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS
    #if DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS > UINT8_MAX
    #undef DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS
    #define DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS RGB_MATRIX_MAXIMUM_BRIGHTNESS
    #endif
    
    #if !defined(DYNAMIC_RGB_MATRIX_DEFAULT_VAL) ||  DYNAMIC_RGB_MATRIX_DEFAULT_VAL > DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS
    #undef DYNAMIC_RGB_MATRIX_DEFAULT_VAL
    #define DYNAMIC_RGB_MATRIX_DEFAULT_VAL DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS
    #endif 
#else 
    #if !defined(DYNAMIC_RGB_MATRIX_DEFAULT_VAL) ||  DYNAMIC_RGB_MATRIX_DEFAULT_VAL > UINT8_MAX
    #undef DYNAMIC_RGB_MATRIX_DEFAULT_VAL
    #define DYNAMIC_RGB_MATRIX_DEFAULT_VAL 200
    #endif
#endif
