...
#define DEFAULT_NUM_LOCK_HSV {240, 255, DYNAMIC_RGB_MATRIX_DEFAULT_VAL}
#endif
...
#define DEFAULT_CAPS_LOCK_HSV {0, 255, DYNAMIC_RGB_MATRIX_DEFAULT_VAL}
#endif
...
#define DEFAULT_SCROLL_LOCK_HSV {120, 255, DYNAMIC_RGB_MATRIX_DEFAULT_VAL}
#endif
...
#   if defined DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS
    if (val > DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS) {
            val = DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS;
    }//动态指示灯RGB
#   endif
    switch (indicator) {
        case 0: {
...
//          rgb_indicators_config.num_lock_config.hsv.v = (val > DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS) ? DYNAMIC_RGB_MATRIX_MAXIMUM_BRIGHTNESS : val; 
            break;
        }
        case 1: {
