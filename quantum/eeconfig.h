...
#define EECONFIG_MAGIC_SETTINGS (uint8_t *)(EECONFIG_BASE_SIZE + 41) //21 - 6 = 15 ,3个指示灯*每个指示灯5字节 = 15
#define EECONFIG_AUTO_SWITCH_LAYERS (uint8_t *)(EECONFIG_BASE_SIZE + 73)//73+5,
#else
...
#define EECONFIG_ZHAQIAN_SIZE 80
#endif
